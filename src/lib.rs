...
// cargo run -p example-prime --bin ianaio_prime_test_server -- examples/prime/dist
//
...
mod tests {
    ...
    async fn prime_worker_works() {
        ...
        let mut bridge = Prime::spawner().spawn("http://127.0.0.1:9999/ianaio_prime_worker.js");
